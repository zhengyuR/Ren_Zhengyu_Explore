...
#define a samll function for the frequency table of every categorical and	logical variable
...
#define a samll function for the summary statistics table for each numerical variable
#parameter:dataframe we input
...
#define a samll function for a data frame that contains each pair	of column names in the	first	column and the associated r-square value in the second column
#parameter:dataframe we input
...
#2c
#define a samll function for a data frame that contains e	each pair	of	column names	in the	first	column and correlation	coefficient	(Pearson)	for	all	coefficients	whose absolute value is	greater than the correlation threshold in the second column
#parameter:dataframe we input
